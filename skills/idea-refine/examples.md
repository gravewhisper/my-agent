...
**User invokes:** `/skill:idea-refine I want to help small local restaurants compete with the big delivery platforms`
...
**User invokes:** `/skill:idea-refine adding real-time collaboration to our document editor`
...
**User invokes:** `/skill:idea-refine a better way to run our weekly team retrospectives — they've gotten stale and people dread them`
